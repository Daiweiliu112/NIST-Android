...
public class Test extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        end_test = (Button) findViewById(R.id.set_button);
                        ...
                        runOnUiThread(new Runnable() {
                            ...
                            public void run() {
                                ...
                                if (seconds_elapsed < 10) {
                                    count_time.setText("0:0" + Integer.toString(seconds_elapsed));
                                } else if (seconds_elapsed >= 10) {
                                    count_time.setText("0:" + Integer.toString(seconds_elapsed));
                                } else {
                                    count_time.setText(Integer.toString(seconds_elapsed / 60) + ":0" + Integer.toString(seconds_elapsed));
                                }
                            }
                        });
                        Thread.sleep(1000);
    ...
    public void next_screen() {
        ...
        intent.putExtra("seconds_elapsed", seconds_elapsed);
